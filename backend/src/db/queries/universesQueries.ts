...
export const CREATE_UNIVERSE =
  "INSERT INTO universes (name, description, cover_image_url) VALUES ($1, $2, $3) RETURNING id, name, description, cover_image_url";
export const UPDATE_UNIVERSE =
  "UPDATE universes SET name = $1, description = $2, cover_image_url = $3 WHERE id = $4";
